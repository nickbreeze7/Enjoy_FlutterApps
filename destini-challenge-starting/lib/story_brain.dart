...
// getChoice1() and getChoice2() so that it gets the updated story and choices
// rather than always just the first (0th) one.
...
//  to change the storyNumber depending on the choice made by the user.
// e.g. if choiceNumber was equal to 1 and the storyNumber is 0,
// the storyNumber should become 2.
